    ...
    private func updateCategories(with categories: [TrackerCategoryModel]) {
        ...
        for category in categories {
            ...
            if newTrackers.count > 0 {
                let newCategory = TrackerCategoryModel(title: category.title, trackers: newTrackers)
...
extension CreateTrackerViewController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(
        ...
        guard let view = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: id, for: indexPath) as? TrackerSupView else { return UICollectionReusableView() }
...
extension CreateTrackerViewController: RegularOrIrregularEventVCDelegate {
    ...
    func createTracker(
        ...
        if categoryToUpdate != nil {
            ...
            let newCategory = TrackerCategoryModel(title: categoryName, trackers: [tracker])
...
extension CreateTrackerViewController {
    ...
    @objc func textFieldChanged() {
        ...
        imageView.image = searchText.isEmpty ? UIImage(named: "TrackerStart") : UIImage(named: "NotFound")
...
extension CreateTrackerViewController: TrackersCollectionViewCellDelegate {
...
extension CreateTrackerViewController: TrackerCategoryStoreDelegate {
